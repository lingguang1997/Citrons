...
- (nonnull instancetype)initWithID:(nonnull NSString *)ID name:(nonnull NSString *)name email:(nullable NSString *)email phoneNumber:(nullable NSString *)phoneNumber title:(nonnull NSString *)title schoole:(nullable NSString *)school degree:(nullable NSString *)degree tags:(nullable NSArray<NSString *> *)tags topics:(nullable NSArray<CTTopic *> *)topics bio:(nullable NSString *)bio links:(nullable NSArray<NSString *> *)links commentsFromExperts:(nullable NSArray<CTComment *> *)commentFromExperts commentsFromUsers:(nullable NSArray<CTComment *> *)commentsFromUsers NS_DESIGNATED_INITIALIZER;
