...
- (void)_parseCustomer {
    ...
    CTRequest *req2 = [[CTRequest alloc] initWithRequestId:@"1" customerId:@"1" expertId:@"1" topicId:@"1" topicTitle:@"Topic" topicRequestedTime:[NSDate date] topicAcceptedTime:[NSDate date] topicScheduledTime:[NSDate date] topicServedTime:[NSDate date] topicRatedTime:[NSDate date] topicComment:comment1 stage:1];
    CTRequest *req3 = [[CTRequest alloc] initWithRequestId:@"1" customerId:@"1" expertId:@"1" topicId:@"1" topicTitle:@"Topic" topicRequestedTime:[NSDate date] topicAcceptedTime:[NSDate date] topicScheduledTime:[NSDate date] topicServedTime:[NSDate date] topicRatedTime:[NSDate date] topicComment:comment1 stage:1];
    
    CTCustomer *customer = [[CTCustomer alloc] initWithID:@"1" name:@"lingguang" email:@"lingguang@gmail.com" phoneNumber:@"18888888888" title:@"工程师" company:@"AK" about:@"一介书生" lastSeenDate:[NSDate date] interestedInExperts:@[expert1, expert2] onGoingTopicRequests:@[req, req2, req3] completedTopicRequests:nil profileImageURL:@"http://cdn5.raywenderlich.com/wp-content/uploads/2015/05/customlayout-tutorial-image.png" profileImageThumbURL:@"http://cdn5.raywenderlich.com/wp-content/uploads/2015/05/customlayout-tutorial-image.png"];
