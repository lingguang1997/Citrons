...
- (void)_parseExpertsModule {
    CTTopic *topic1 = [[CTTopic alloc] initWithTitle:@"如何设计一个推荐系统?" price:200 salePrice:100 detail:@"test" duration:1];
    ...
    CTLink *link = [[CTLink alloc] initWithLinkText:@"LinkIn profile" urlString:@"https://www.linkedin.com/in/zijiao-liu-5b110217"];
    CTExpert *expert1 = [[CTExpert alloc] initWithID:@"10" name:@"Zijiao Liu" email:@"lingguang1997@gmail.com" phoneNumber:@"301-775-2528" title:@"Engineer" schoole:@"New York University" degree:@"Master" tags:@[@"Mobile", @"iOS Infra"] topics:@[topic1, topic2] bio:@"..." links:@[link] credits:10 commentsFromExperts:@[comment1] commentsFromUsers:@[comment2] profileImageURL:@"http://i.dailymail.co.uk/i/pix/2011/10/08/article-0-0E47CBDB00000578-196_468x433.jpg"];
    CTExpert *expert2 = [[CTExpert alloc] initWithID:@"11" name:@"Zijiao Liu1" email:@"lingguang1997@gmail.com" phoneNumber:@"301-775-2528" title:@"Engineer" schoole:@"New York University" degree:@"Master" tags:@[@"Mobile", @"iOS Infra"] topics:@[topic1, topic2] bio:@"..." links:@[link] credits:10 commentsFromExperts:@[comment1] commentsFromUsers:@[comment2] profileImageURL:@"http://insidescoopsf.sfgate.com/files/2011/05/zuckerberg.jpg"];
    CTExpert *expert3 = [[CTExpert alloc] initWithID:@"12" name:@"Zijiao Liu2" email:@"lingguang1997@gmail.com" phoneNumber:@"301-775-2528" title:@"Engineer" schoole:@"New York University" degree:@"Master" tags:@[@"Mobile", @"iOS Infra"] topics:@[topic1, topic2] bio:@"..." links:@[link] credits:10 commentsFromExperts:@[comment1] commentsFromUsers:@[comment2] profileImageURL:@"http://static4.businessinsider.com/image/53d6c91a6bb3f774472d9227-480/bill-gates.jpg"];
...
- (void)_parseRecommendedExperts {
    ...
    CTExpert *expert3 = [[CTExpert alloc] initWithID:@"12" name:@"Zijiao Liu2" email:@"lingguang1997@gmail.com" phoneNumber:@"301-775-2528" title:@"Engineer" schoole:@"New York University" degree:@"Master" tags:@[@"Mobile", @"iOS Infra"] topics:@[topic1, topic2] bio:@"..." links:@[link1] credits:8 commentsFromExperts:@[comment1] commentsFromUsers:@[comment2] profileImageURL:@"http://cdn1.raywenderlich.com/wp-content/uploads/2012/09/12.png"];
